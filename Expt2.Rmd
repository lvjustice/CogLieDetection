...
ggplot(data = Df2) + geom_bar(aes(x = stim_serial_order, colour = mem_type))
...
#ordinal model
expt2_serial_order <- brm(stim_serial_order ~ mem_type + (mem_type|ID) + (mem_type|mem_cue), data = Df2, family = cumulative("logit"))
